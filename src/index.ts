...
//         // oxc: { inject },
//         optimizeDeps: {
//           exclude: Object.values(inject),
//           rolldownOptions: {
//             resolve: { alias },
//             transform: { define },
//             plugins: [{
//               name: 'banner-polyfills',
//               banner,
//             }]
//           },
//         },
...
// const injectMap = {
//   buffer: require.resolve('./buffer/index', { paths: [__dirname] }),
//   global: require.resolve('./global/index', { paths: [__dirname] }),
//   process: require.resolve('./process/index', { paths: [__dirname] }),
// }
...
//   buffer: [
//     `import __buffer_polyfill from '${injectMap.buffer}'`,
//     `globalThis.Buffer = globalThis.Buffer || __buffer_polyfill`,
//   ],
//   global: [
//     `import __global_polyfill from '${injectMap.global}'`,
//     `globalThis.global = globalThis.global || __global_polyfill`,
//   ],
//   process: [
//     `import __process_polyfill from '${injectMap.process}'`,
...
//     ...((isEnabled(optionsResolved.globals.Buffer, 'dev')) ? [injectMap.buffer] : []),
//     ...((isEnabled(optionsResolved.globals.global, 'dev')) ? [injectMap.global] : []),
//     ...((isEnabled(optionsResolved.globals.process, 'dev')) ? [injectMap.process] : []),
//   ]
...
//         ...(isEnabled(optionsResolved.globals.Buffer, 'build') ? { Buffer: injectMap.buffer } : {}),
//         ...(isEnabled(optionsResolved.globals.global, 'build') ? { global: injectMap.global } : {}),
//         ...(isEnabled(optionsResolved.globals.process, 'build') ? { process: injectMap.process } : {}),
//       }
